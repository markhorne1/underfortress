      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', overflowY: 'auto', position: 'relative', background: '#2a2a2a' }}>
        ...
        {area ? (
          <div style={{ maxWidth: 800, width: '100%', position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', flex: 1, padding: '20px 20px 0 20px' }}>
            <h1 style={{ marginTop: 16, marginBottom: 0, textAlign: 'center', fontSize: 22, color: '#f5e6c8', textShadow: '0 2px 4px rgba(0,0,0,1), 0 4px 12px rgba(0,0,0,0.8), 0 0px 20px rgba(0,0,0,0.5)', letterSpacing: 1 }}>{area.title ?? area.id}</h1>
            <div style={{ flex: 1 }} />
            <div style={{ background: 'rgba(30,28,24,0.10)', backdropFilter: 'blur(4px)', borderRadius: 12, padding: '20px 28px', border: '1px solid rgba(201,168,76,0.25)', boxShadow: '0 8px 32px rgba(0,0,0,0.5)' }}>
              <p style={{ whiteSpace: 'pre-wrap', lineHeight: 1.6, textAlign: 'center', color: '#e8dcc8', textShadow: '0 2px 4px rgba(0,0,0,1), 0 4px 12px rgba(0,0,0,0.8), 0 0px 20px rgba(0,0,0,0.5)' }}>{area.description}</p>
              {actionResult && (
                <div style={{ marginTop: 12, padding: '12px 16px', borderRadius: 8, background: actionResult.success ? 'rgba(46,204,113,0.15)' : 'rgba(231,76,60,0.15)', border: `1px solid ${actionResult.success ? 'rgba(46,204,113,0.4)' : 'rgba(231,76,60,0.4)'}` }}>
                  {actionResult.log.map((line, i) => (
                    <p key={i} style={{ margin: i === 0 ? 0 : '6px 0 0', fontSize: 14, lineHeight: 1.5, color: actionResult.success ? '#2ecc71' : '#e74c3c', textAlign: 'center', textShadow: '0 2px 4px rgba(0,0,0,1), 0 4px 12px rgba(0,0,0,0.8), 0 0px 20px rgba(0,0,0,0.5)' }}>{line}</p>
                  ))}
                </div>
              )}
            </div>
